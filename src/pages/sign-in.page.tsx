...
export default function SignIn() {
  ...
  return (
    <>
      <NextSeo
        title="Faça login ou entre como visitante | BookWise"
        description="Entre com sua conta do Google ou GitHub para avaliar os livros que você já leu, ou acesse como visitante."
      />
